...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 209 | 167 | vote-interface@v5.1.1 (Feb 18, 2026) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 659 | 158 | v6.1.0 (Feb 16, 2026) | SDKs & Tooling |
...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 313 | 1 | Last commit (Feb 19, 2026) | SDKs & Tooling |
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 556 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 916 | 30 | Last commit (Feb 18, 2026) | SDKs & Tooling |
...
| radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 122 | 4 | Last commit (Feb 19, 2026) | SDKs & Tooling |
...
| EVM-Solana-Casino-Games | Blockchain Web3 Solana Casino Game | 🌐Multi-Chain Casino Platform | EVM + Sui |  10 Provably Fair Games | ORAO + Chainlink VRF |  Crash, Plinko, Dice, Blackjack, Roulette, Poker, Hi-Lo, Limbo, Coinflip. Contact for solana casino game building and solana casino game customization evm solana evm solana evm solana evm solana evm solana evm solana | https://github.com/LaChance-Lab/EVM-Solana-Casino-Games | 302 | 1 | Last commit (Feb 03, 2026) | SDKs & Tooling |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 410 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| shank | Extracts IDL from Solana Rust contracts | https://github.com/metaplex-foundation/shank | 222 | 10 | Last commit (Feb 12, 2026) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 410 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| wc-solana-pay | Solana Pay powered payment gateway for WordPress and WooCommerce | https://github.com/aztemi/wc-solana-pay | 9 | 1 | Last commit (Dec 24, 2025) | Payments |
...
| pumpfun-raydium-cli-tools | solana pumpfun bundler, raydium bundler, pumpfun sniping bot, raydium sniping bot, pumpfun volume bot, raydium volume bot, pumpfun bundler, raydium bundler, jito bundler | https://github.com/hexnome/pumpfun-raydium-cli-tools | 174 | 1 | Last commit (Mar 25, 2025) | DeFi |
